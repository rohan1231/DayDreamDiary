			...
			if($_POST['sign'] == '1'){
				...
				if($_POST['password'] != $_POST['ConfirmPassword']){
					...
					if(mysqli_num_rows($result) > 0){
						...
						// $query = "INSERT INTO `users`( `name`, `email`, `password`) VALUES ('".mysqli_escape_string($link, $_POST['name'])."', ('".mysqli_escape_string($link, $_POST['email'])."','".mysqli_escape_string($link, $_POST['password'])."')";
...
<body>
	...
	<div class="container col-md-6" id="header">
		<div id="heading">
			<h1 class="display-4">Day Dream Diary</h1>
			<small id="emailHelp" class="form-text text-muted"><b>Store your best life moments, Dream and secret in your online day dream diary.</b></small>
		</div>
		...
		<div id="signUp">	
				...
				<form method="post">
				      <div class="form-group">
					    <input type="text" name="name" class="form-control" id="exampleInputName" aria-describedby="nameHelp" placeholder="Enter Full Name">
					  </div>
					  <div class="form-group">
				...
				<p><b>Already registered </b></h1><a href="#login" id="clickLogIn"> Log in</a></p>
		</div>
